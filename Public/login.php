...
if (isset($_POST['submit'])) {
    ...
    if ($countLandlord==1) {
        ...
        header("Location:/Raaz/project/Room-Finder-Application-Project-I-/Landlord/landlordHome.php");
        exit();
        // } 
    ...
    if ($countTenant==1) {
        ...
        $_SESSION['email']= $array['email'];
        $_SESSION['contact']= $array['contact'];
        header("Location:/Raaz/project/Room-Finder-Application-Project-I-/Tenant/tenantHome.php");
        exit();
        // } 
